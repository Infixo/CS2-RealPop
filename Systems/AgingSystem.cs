...
namespace RealPop.Systems
{
    ...
    //[CompilerGenerated]
    public partial class AgingSystem_RealPop : GameSystemBase
    {
        //[BurstCompile]
        ...
        protected override void OnCreate()
        {
            ...
            // RealPop
            s_TeenAgeLimitInDays = Mod.setting.TeenAgeLimitInDays;
            s_AdultAgeLimitInDays = Mod.setting.AdultAgeLimitInDays;
            s_ElderAgeLimitInDays = Mod.setting.ElderAgeLimitInDays;
            Mod.log.Info($"Modded AgingSystem created. Age thresholds: {s_TeenAgeLimitInDays}, {s_AdultAgeLimitInDays}, {s_ElderAgeLimitInDays}.");
        }
